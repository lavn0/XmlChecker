...
namespace UnitTestProject
{
	...
	public class XmlRuleXPathTest
	{
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1003_OK.xaml", "Resources")]
		public void XA1003_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1003_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1003_NG1.xaml", "Resources")]
		public void XA1003_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1003", "Default", @"//*[name(.)='ListBox']/@HorizontalAlignment[.='Stretch']", @"ListBox.HorizontalAlignment=""Stretch""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1003_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1004_OK.xaml", "Resources")]
		public void XA1004_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1004_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1004_NG1.xaml", "Resources")]
		public void XA1004_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1004", "Default", @"//*[name(.)='ListBox']/@VerticalAlignment[.='Stretch']", @"ListBox.VerticalAlignment=""Stretch""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1004_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1006_OK.xaml", "Resources")]
		public void XA1006_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1006_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1006_NG1.xaml", "Resources")]
		public void XA1006_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1006", "Default", @"//*[name(.)='ListBox']/@VerticalContentAlignment[.='Top']", @"ListBox.VerticalContentAlignment=""Top""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1006_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1008_OK.xaml", "Resources")]
		public void XA1008_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1008_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1008_NG5.xaml", "Resources")]
		public void XA1008_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1008", "Default", @"//*[name(.)='ListBox'][not(@Name)]/@Padding[.='1' or .='1,1' or .='1 1' or .='1,1,1,1' or .='1 1 1 1']", @"ListBox.Padding=""1""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1008_NG5.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(5, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1009_OK.xaml", "Resources")]
		public void XA1009_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1009_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1009_NG5.xaml", "Resources")]
		public void XA1009_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1009", "Default", @"//*[name(.)='ListBox'][not(@Name)]/@BorderThickness[.='1' or .='1,1' or .='1 1' or .='1,1,1,1' or .='1 1 1 1']", @"ListBox.BorderThickness=""1""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1009_NG5.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(5, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1010_OK.xaml", "Resources")]
		public void XA1010_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1010_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1010_NG3.xaml", "Resources")]
		public void XA1010_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1010", "Default", @"//*[name(.)='ListBox'][not(@Name)]/@Background[.='White' or .='#FFFFFFFF' or .='#FFFFFF']", @"ListBox.Background=""White""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1010_NG3.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(3, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1012_OK.xaml", "Resources")]
		public void XA1012_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1012_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1012_NG1.xaml", "Resources")]
		public void XA1012_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1012", "Default", @"//*[name(.)='ListBox'][not(@Name)]/@*[name(.)='ScrollViewer.VerticalScrollBarVisibility'][.='Auto']", @"ListBox.VerticalScrollBarVisibility=""Auto""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1012_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1102_OK.xaml", "Resources")]
		public void XA1102_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1102_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1102_NG1.xaml", "Resources")]
		public void XA1102_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1102", "Default", @"//*[name(.)='ComboBox']/@IsEnabled[.='True']", @"ComboBox.IsEnabled=""True""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1102_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1103_OK.xaml", "Resources")]
		public void XA1103_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1103_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1103_NG1.xaml", "Resources")]
		public void XA1103_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1103", "Default", @"//*[name(.)='ComboBox']/@HorizontalAlignment[.='Stretch']", @"ComboBox.HorizontalAlignment=""Stretch""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1103_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1104_OK.xaml", "Resources")]
		public void XA1104_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1104_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1104_NG1.xaml", "Resources")]
		public void XA1104_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1104", "Default", @"//*[name(.)='ComboBox']/@VerticalAlignment[.='Stretch']", @"ComboBox.VerticalAlignment=""Stretch""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1104_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1105_OK.xaml", "Resources")]
		public void XA1105_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1105_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1105_NG1.xaml", "Resources")]
		public void XA1105_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1105", "Default", @"//*[name(.)='ComboBox']/@HorizontalContentAlignment[.='Left']", @"ComboBox.HorizontalContentAlignment=""Left""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1105_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1106_OK.xaml", "Resources")]
		public void XA1106_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1106_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1106_NG1.xaml", "Resources")]
		public void XA1106_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1106", "Default", @"//*[name(.)='ComboBox']/@VerticalContentAlignment[.='Top']", @"ComboBox.VerticalContentAlignment=""Top""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1106_NG1.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(1, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1107_OK.xaml", "Resources")]
		public void XA1107_OK()
		{
			...
			var xaml = File.ReadAllText(@"Resources\XA1107_OK.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(0, errorInstances.Count);
		}
		...
		[TestMethod]
		[TestCategory("XmlChecker")]
		[DeploymentItem(@"Resources\XA1107_NG5.xaml", "Resources")]
		public void XA1107_NG()
		{
			var rule = new XmlRuleXPath(string.Empty, 0, new string[] { "XA1107", "Default", @"//*[name(.)='ComboBox'][not(@Name)]/@Margin[.='0' or .='0,0' or .='0 0' or .='0,0,0,0' or .='0 0 0 0']", @"ComboBox.Margin=""0""はデフォルト値です。", });
			var xaml = File.ReadAllText(@"Resources\XA1107_NG5.xaml");
			var xdoc = XDocument.Parse(xaml, LoadOptions.SetLineInfo);
			var errorInstances = ((IEnumerable<object>)xdoc.XPathEvaluate(rule.XPath)).Cast<XObject>().ToList();
			Assert.AreEqual(5, errorInstances.Count);
		}
